...
package komandara_k10_pkg;
  ...
  // =========================================================================
  // Debug Trigger Module (Sdtrig)
  // =========================================================================
  parameter int NUM_TRIGGERS = 6;

  parameter logic [11:0] CSR_TSELECT    = 12'h7A0;
  parameter logic [11:0] CSR_TDATA1     = 12'h7A1;
  parameter logic [11:0] CSR_TDATA2     = 12'h7A2;
  parameter logic [11:0] CSR_TINFO      = 12'h7A4;

  typedef struct packed {
    logic [3:0]  type_id;   // [31:28] = 4'h2 (mcontrol)
    logic        dmode;     // [27]
    logic [5:0]  maskmax;   // [26:21]
    logic        hit;       // [20]
    logic        select;    // [19]
    logic        timing;    // [18]
    logic [1:0]  sizelo;    // [17:16]
    logic [3:0]  action;    // [15:12]
    logic        chain;     // [11]
    logic [3:0]  match;     // [10:7]
    logic        m;         // [6] (Machine mode enable)
    logic        reserved;  // [5] (s-mode not supported)
    logic        u;         // [4] (User mode enable)
    logic        execute;   // [3] (Instruction fetch)
    logic        store;     // [2] (Data store)
    logic        load;      // [1] (Data load)
    logic        reserved0; // [0]
  } mcontrol_t;

  typedef enum logic [3:0] {
    TRIG_TYPE_NONE     = 4'h0,
    TRIG_TYPE_MCONTROL = 4'h2
  } trigger_type_e;
